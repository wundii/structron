...
class StructronProcessTaskTest extends TestCase
{
    public function testRegexError()
    {
        ...
        foreach ($errorMessages as $kex => $errorMessage) {
            $matched = preg_match(StructronProcessTask::REGEX_ERROR, $errorMessage, $matches);
    ...
    public function testRegexWarning()
    {
        ...
        foreach ($warningMessages as $key => $warningMessage) {
            $matched = preg_match(StructronProcessTask::REGEX_WARNING, $warningMessage, $matches);
    ...
    public function testGetProcessResult()
    {
        ...
        $structronProcessTask = new StructronProcessTask($structronConfig, $processMock, $splFileInfoMock);
        $result = $structronProcessTask->getProcessResult();

        $this->assertInstanceOf(StructronProcessResult::class, $result);
